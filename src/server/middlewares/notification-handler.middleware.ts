...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Project Posted.create': { roles: ['freelancer', 'client'], key: 'project', tenantPath: [], userPath: [] },
  'Proposal Submitted.create': { roles: ['freelancer', 'client'], key: 'proposal', tenantPath: [], userPath: [] },
  'Proposal Accepted.update': { roles: ['freelancer'], key: 'proposal', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['freelancer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['freelancer', 'client'];
