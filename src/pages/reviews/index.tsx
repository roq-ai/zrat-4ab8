...
export function ReviewListPage(props: ReviewListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReviews({
        relations: ['user_review_client_idTouser', 'user_review_freelancer_idTouser'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_review_client_idTouser',
          header: 'User Review Client Id Touser',
          accessorKey: 'user_review_client_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_review_client_idTouser?.id}`}
            >
              {record.user_review_client_idTouser?.email}
            </Link>
          ),
        }
      : null,
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_review_freelancer_idTouser',
          header: 'User Review Freelancer Id Touser',
          accessorKey: 'user_review_freelancer_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_review_freelancer_idTouser?.id}`}
            >
              {record.user_review_freelancer_idTouser?.email}
            </Link>
          ),
        }
      : null,
