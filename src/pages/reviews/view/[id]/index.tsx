            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Review Client Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_review_client_idTouser?.id}`}>
                        {data?.user_review_client_idTouser?.email}
                      </Link>
                    }
                  />
                )}
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Review Freelancer Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_review_freelancer_idTouser?.id}`}>
                        {data?.user_review_freelancer_idTouser?.email}
                      </Link>
                    }
                  />
                )}
